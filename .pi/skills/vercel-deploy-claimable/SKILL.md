...
```bash
bash .pi/skills/vercel-deploy-claimable/scripts/deploy.sh [path]
```
...
bash .pi/skills/vercel-deploy-claimable/scripts/deploy.sh

# Deploy specific project
bash .pi/skills/vercel-deploy-claimable/scripts/deploy.sh /path/to/project

# Deploy existing tarball
bash .pi/skills/vercel-deploy-claimable/scripts/deploy.sh /path/to/project.tgz
```
