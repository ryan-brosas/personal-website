...
A comprehensive Agent Skill reference for working with Cloudflare Workers AI.
...
Load `/skill:cloudflare` when working on Workers AI projects, then use this reference for the Workers AI-specific boundary.
...
- [x] **Complete Code Examples**: Every pattern has working code
- [x] **TypeScript First**: Proper typing for all examples
- [x] **Real-World Patterns**: RAG, streaming, batch processing
- [x] **Cost Optimization**: Pricing info and model selection guidance
- [x] **Troubleshooting**: Common issues and solutions
- [x] **Best Practices**: Error handling, type safety, monitoring
...
This skill documentation is provided as-is for use with Pi and other Agent Skills-compatible harnesses.
