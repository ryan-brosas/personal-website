...
14. Index every canonical applied artifact intended for Design System Assets. Keep the landing page as the primary preview, register the client pitch as a separate preview page with its deck sidecar, and generate `system/artifacts/deck.html` with package assets rebased two levels for the fixed deck renderer.
