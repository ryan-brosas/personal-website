...
14. Index every canonical applied artifact intended for Design System Assets. Keep the landing page as the primary preview, register the client pitch, campaign poster, service email, build-breakdown newsletter, and workflow service inquiry as separate preview pages with sidecars, and generate `system/artifacts/deck.html`, `system/artifacts/poster.html`, `system/artifacts/email.html`, and `system/artifacts/newsletter.html` with package resources rebased two levels for their fixed renderer slots.
