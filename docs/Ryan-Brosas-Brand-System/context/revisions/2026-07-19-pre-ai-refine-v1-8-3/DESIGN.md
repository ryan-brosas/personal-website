...
> Package version: `1.8.2` — the landing page is registered as the living applied asset proof, with identity, narrative, editorial, and utility layers visible in use  
