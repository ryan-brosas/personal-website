(function () {
  ...
  function AppShell(data, track) {
    ...
    return [
      ...
      '      <h1>' + trackData.headline + '</h1>',
      '      <p>' + trackData.intro + '</p>',
      '      <div class="hero-actions">',
      '        <button class="button button--primary" type="button" data-action="copy-statement">Copy primary statement</button>',
      '        <a class="button button--secondary" href="../../preview/brand-assets.html">Inspect brand assets</a>',
      '      </div>',
      '    </div>',
      ...
      '      <span class="mono-label">Primary statement / exact language</span>',
      '    </aside>',
      '  </section>',
      '  <section class="workbench-section" data-od-id="kit-status-section">',
      '    <div class="section-heading"><span class="section-index">01 / Evidence status</span><h2>Facts stay separate from guesses.</h2></div>',
      '    <div class="status-grid">' + statuses + '</div>',
      '  </section>',
      '  <section class="workbench-section" data-od-id="kit-system-section">',
      '    <div class="section-heading"><span class="section-index">02 / System choice</span><h2>The agent is only one part.</h2></div>',
      window.SystemMap(),
      '  </section>',
      '  <section class="workbench-section" id="presentation" data-od-id="kit-project-section">',
      '    <div class="section-heading section-heading--split">',
      '      <div><span class="section-index">03 / Applied evidence</span><h2>Show the work, including the bugs.</h2></div>',
      ...
      '        <button type="button" data-filter="presentation" aria-pressed="false">Presentation</button>',
      '        <button type="button" data-filter="guidelines" aria-pressed="false">Guidelines</button>',
      '      </div>',
      '    </div>',
