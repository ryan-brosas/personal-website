(function () {
  ...
  function Navigation(options) {
    ...
    return [
      ...
      '  </a>',
      '  <button class="nav-toggle" type="button" aria-expanded="false" aria-controls="kit-primary-navigation" data-nav-toggle data-od-id="kit-navigation-toggle">' + window.UtilityIcon("menu", "icon--menu") + '<span>Open primary pages</span>' + window.UtilityIcon("chevron-down", "icon--chevron") + '</button>',
