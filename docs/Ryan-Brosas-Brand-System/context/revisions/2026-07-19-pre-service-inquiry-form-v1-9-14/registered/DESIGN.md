...
> Package version: `1.9.13` — the system now includes a reusable agent build-breakdown newsletter with honest replacement slots and a fixed renderer mirror  
...
22. Confirm Design System Assets exposes `showcase-landing-page.html`, `founder-dependence-client-pitch-deck.html`, `building-systems-social-poster.html`, `agent-systems-service-introduction-email.html`, and `agent-build-breakdown-newsletter-template.html`; the landing page remains primary, every artifact has its sidecar, `system/artifacts/landing.html`, `system/artifacts/deck.html`, `system/artifacts/poster.html`, `system/artifacts/email.html`, and `system/artifacts/newsletter.html` exist in canonical and registered packages, and every nested renderer resource resolves after its two-level path rebase.
