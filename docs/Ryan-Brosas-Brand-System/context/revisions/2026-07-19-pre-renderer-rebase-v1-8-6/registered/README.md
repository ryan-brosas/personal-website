...
Version 1.8.5 closes the Assets renderer path as well as Library discovery. `showcase-landing-page.html` remains the generated Library-index mirror, while `system/artifacts/landing.html` is the generated renderer mirror required by the Design System Assets surface. Both come from the canonical `ryan-brosas-landing-page.html`, which remains the only independently edited source.
