...
> Package version: `1.8.6` — the canonical landing page feeds the Library index and a path-rebased Design System Assets renderer mirror, while runtime lifecycle and content-safety contracts remain synchronized  
