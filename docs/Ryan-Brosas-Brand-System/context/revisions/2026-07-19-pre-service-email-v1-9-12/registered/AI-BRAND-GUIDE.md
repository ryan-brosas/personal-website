...
14. Index every canonical applied artifact intended for Design System Assets. Keep the landing page as the primary preview, register the client pitch and campaign poster as separate preview pages with sidecars, and generate `system/artifacts/deck.html` plus `system/artifacts/poster.html` with package resources rebased two levels for their fixed renderer slots.
