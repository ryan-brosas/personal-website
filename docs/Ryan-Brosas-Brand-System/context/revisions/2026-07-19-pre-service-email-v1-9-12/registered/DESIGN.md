...
> Package version: `1.9.11` — the registered 4:5 campaign proof now includes the fixed poster-renderer mirror required by Design System Assets  
...
22. Confirm Design System Assets exposes `showcase-landing-page.html`, `founder-dependence-client-pitch-deck.html`, and `building-systems-social-poster.html`; the landing page remains primary, every artifact has its sidecar, `system/artifacts/landing.html`, `system/artifacts/deck.html`, and `system/artifacts/poster.html` exist in canonical and registered packages, and every nested renderer resource resolves after its two-level path rebase.
