...
> Package version: `1.9.12` — the system now includes a founder-first service-introduction email with a fixed renderer mirror and explicit reply path  
...
22. Confirm Design System Assets exposes `showcase-landing-page.html`, `founder-dependence-client-pitch-deck.html`, `building-systems-social-poster.html`, and `agent-systems-service-introduction-email.html`; the landing page remains primary, every artifact has its sidecar, `system/artifacts/landing.html`, `system/artifacts/deck.html`, `system/artifacts/poster.html`, and `system/artifacts/email.html` exist in canonical and registered packages, and every nested renderer resource resolves after its two-level path rebase.
