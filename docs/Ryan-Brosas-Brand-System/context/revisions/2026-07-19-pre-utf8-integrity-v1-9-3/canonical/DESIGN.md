...
> Package version: `1.9.2` — the measured pitch-deck proof now defines reusable presentation roles, evidence boundaries, and fixed-canvas safety without changing the verified palette or calm typography scale  
