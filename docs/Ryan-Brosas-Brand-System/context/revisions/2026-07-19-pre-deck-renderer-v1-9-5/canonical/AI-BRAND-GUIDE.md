...
14. Index every canonical applied artifact intended for Design System Assets. Keep the landing page as the primary preview, and register the client pitch as a separate preview page with its deck sidecar.
