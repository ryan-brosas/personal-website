...
Version 1.9.8 adds the canonical 1080 × 1350 “Building systems” social poster as a registered campaign asset without changing the palette, design-system id, or landing-page primary role. The poster applies the approved System Conductor hero, charcoal-on-coral campaign typography, the protected yellow logo tile, and honest systems language. The canonical pitch keeps its fixed-canvas typography floors, and the exact seven-file runtime inventory remains unchanged.
