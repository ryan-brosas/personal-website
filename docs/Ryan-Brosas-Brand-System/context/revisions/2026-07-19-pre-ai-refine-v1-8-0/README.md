...
Version 1.7.2 explicitly resolves dark-mode component foreground aliases for navigation, panels, fields, feedback, links, and evidence. The nine downstream previews load `tokens.css`; the validator-required applied-kit reference remains on the byte-identical maintainer source.
