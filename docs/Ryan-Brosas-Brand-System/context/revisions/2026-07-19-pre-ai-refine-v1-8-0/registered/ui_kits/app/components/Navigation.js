(function () {
  ...
  function Navigation(options) {
    ...
    return [
      ...
      '  </a>',
      '  <button class="nav-toggle" type="button" aria-expanded="false" aria-controls="kit-primary-navigation" data-nav-toggle data-od-id="kit-navigation-toggle">Open primary pages</button>',
