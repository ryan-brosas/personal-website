...
Version 1.7.0 raises light-mode tertiary text to a contrast-safe role, adds explicit loading, validating, valid, empty, error, and recovery tokens, and makes the single-entry token contract unambiguous across human and machine guidance.
