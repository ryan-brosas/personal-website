(function () {
  ...
  function Navigation(options) {
    ...
    return [
      ...
      '    <span class="brand-tile"><img src="../../logos/Logo---Ryan-1.svg" alt="" /></span>',
      '    <span class="brand-copy"><strong>Ryan Brosas</strong><span>Agent Systems Builder</span></span>',
      '  </a>',
      '  <button class="nav-toggle" type="button" aria-expanded="false" aria-controls="kit-primary-navigation" data-nav-toggle data-od-id="kit-navigation-toggle"><svg class="icon icon--menu" aria-hidden="true" focusable="false"><use href="../../assets/icons.svg#icon-menu"></use></svg><span>Open primary pages</span><svg class="icon icon--chevron" aria-hidden="true" focusable="false"><use href="../../assets/icons.svg#icon-chevron-down"></use></svg></button>',
